...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setStyleSheet(QStringLiteral("text-alignment : center;"));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 50, 211, 41));
        label_3 = new QLabel(centralWidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(50, 90, 91, 17));
        ...
        label_5->setGeometry(QRect(50, 130, 121, 17));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(100, 180, 261, 81));
...
"border-radius: 20px;"));
        ...
        radioButton->setGeometry(QRect(20, 110, 16, 23));
        radioButton_2 = new QRadioButton(centralWidget);
        radioButton_2->setObjectName(QStringLiteral("radioButton_2"));
        radioButton_2->setGeometry(QRect(20, 90, 16, 23));
        radioButton_3 = new QRadioButton(centralWidget);
        radioButton_3->setObjectName(QStringLiteral("radioButton_3"));
        radioButton_3->setGeometry(QRect(20, 130, 16, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_3->setText(QApplication::translate("MainWindow", "PO\304\214ETNIK", 0));
